...
filter_menu_parser = menu_subparsers.add_parser('filter', help='Filter menu items')
filter_menu_parser.add_argument('name', type=str, help='Name of the food')
...
update_order_parser.add_argument('--menu_items', type=str, help='Update customer name')
...
filter_staff_parser = staff_subparsers.add_parser('filter', help='staff for each order')
filter_staff_parser.add_argument('staff_name',type = str, help='Name of the staff member')
