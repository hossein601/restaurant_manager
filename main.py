...
update_order_parser.add_argument("--customer", type=str, help="Updated customer name")
update_order_parser.add_argument("--menu_items", nargs='+', type=int, help="Updated list of menu item IDs")
...
if args.command == "menu":
    ...
    if args.menu_command == "list":
        ...
        print(f"Menu item {updated_item.id} updated.")
    ...
    if args.order_command == "list":
        ...
        new_order = order_controller.create_order(args.menu_items, args.customer, args.total_price, args.staff_id)
        print(f"Order {new_order.order_id} created.")
    ...
    if args.staff_command == "list":
        ...
        print(f"Staff member {updated_staff.name} updated.")
